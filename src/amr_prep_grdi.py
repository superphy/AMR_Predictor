...
if __name__ == "__main__":
	...
	df = joblib.load(os.path.abspath(os.path.curdir)+"/data/grdi_mic_class_dataframe.pkl")
	...
	kmer_matrix = np.load(os.path.abspath(os.path.curdir)+"/data/grdi_unfiltered/kmer_matrix.npy")
	kmer_cols = np.load(os.path.abspath(os.path.curdir)+"/data/grdi_unfiltered/kmer_cols.npy")
	kmer_rows = np.load(os.path.abspath(os.path.curdir)+"/data/grdi_unfiltered/kmer_rows.npy")
	...
	for drug in df_cols:
		...
		if not os.path.exists(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug):
			os.mkdir(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug)
		...
		np.save(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug+'/kmer_rows_genomes.npy', new_kmer_rows)
		...
		joblib.dump(new_df, os.path.abspath(os.path.curdir)+'/data/grdi_'+drug+'/mic_df.pkl')
		np.save(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug+'/kmer_matrix.npy', new_kmer_matrix)
		np.save(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug+'/kmer_rows_mic.npy', new_kmer_rows)
		np.save(os.path.abspath(os.path.curdir)+'/data/grdi_'+drug+'/kmer_cols.npy', kmer_cols)
