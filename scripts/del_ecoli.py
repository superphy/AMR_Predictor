...
if __name__ == '__main__':
	...
	"""
	genome_list = []
	mic_df = pd.ExcelFile(os.path.abspath(os.path.curdir)+'/amr_data/Updated_GenotypicAMR_Master.xlsx').parse('GenotypicAMR_Master')
	...
	for genome in genome_list:
		...
		os.remove(os.path.abspath(os.path.curdir)+'/genomes/raw/'+genome+'.fasta')